...
export default function Home() {
  ...
  const faqs = [
    {
      q: "Какво е алтернативният режим?",
      a: "Това е законов режим по Наредба Н-18 за онлайн търговци, който позволява отчитане на продажби чрез електронни бележки вместо касов апарат.",
    },
    {
      ...
      >
        ...
        <div className="apple-hero__content">
          ...
          <p className="apple-hero__subtitle">
            Алтернативен режим за отчитане на продажби. Интеграция с Wix за минути.
          </p>
