      ...
      <div className="container">
        <section className="hero">
          <div>
            ...
            <p>
              UDITO е софтуер за издаване на електронни касови бележки и генериране
          ...
          <div className="hero-card">
            ...
            <ul className="help-nav">
              ...
              <li><a href="#receipts">Касови бележки</a></li>
        ...
        <section className="help-section" id="connection">
          ...
          <div className="help-content">
            ...
            <ul>
              ...
              <li>Можете да настроите фирмените данни за касовите бележки</li>
            </ul>
        ...
        <section className="help-section" id="orders">
          ...
          <div className="help-content">
            ...
            <ul>
              <li><strong>Нова поръчка:</strong> Записва се в системата със статус "Неплатена"</li>
              <li><strong>Плащане получено:</strong> Статусът се обновява на "Платена"</li>
              <li><strong>Автоматична бележка:</strong> При маркиране като платена се издава касова бележка</li>
            </ul>
        ...
        <section className="help-section" id="receipts">
          ...
          <div className="help-content">
            <p>
              Електронните касови бележки се издават автоматично при получаване на плащане.
            </p>
        ...
        <section className="help-section" id="audit">
          ...
          <div className="help-content">
            ...
            <h3>Какво съдържа</h3>
            <ul>
              <li>Списък на всички поръчки <strong>с издадени касови бележки</strong></li>
            ...
            <div className="help-note">
              ...
              за които е издадена касова бележка. Поръчки без бележка не се включват.
            </div>
        ...
        <section className="help-section" id="settings">
          ...
          <div className="help-content">
            ...
            <p>
              ...
              които ще се отпечатват върху касовите бележки:
            </p>
            <ul>
            ...
            <h3>Настройки на касовите бележки</h3>
            <p>
        ...
        <section className="help-section">
          ...
          <div className="help-content">
            ...
            <div className="help-faq">
              ...
              <p>
                Не. Касови бележки се издават само за поръчки, създадени след
